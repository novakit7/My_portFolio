                ...
                <div className="collapse navbar-collapse" id="navbarNav">
                    <ul className="navbar-nav ms-auto">
                        <li className="nav-item">
                            <Link className="nav-link active mx-3" onClick={closeMenu} aria-current="page" to="/"><span className="has">#</span>Home</Link>
                        </li>
                        <li className="nav-item">
                        ...
                        <li className="nav-item">
                            <Link className="nav-link active mx-3" onClick={closeMenu} to="about"><span className="has">#</span>About</Link>
                        </li>
                    </ul>
                </div>
            </div>
